...
class Parser(object):
    def __init__(self, root_path='./data'):
        self.DATA_PATH_ROOT = root_path
        self.RAW_CSV_PATH = os.path.join(self.DATA_PATH_ROOT, 'raw_comments.csv')


    def save_comments_to_csv(self, group):
        ...
        with open(self.RAW_CSV_PATH, 'w') as file:
...
def main():
    parser = Parser()
    parser.save_comments_to_csv('https://vk.com/planetasushi_ru')
    #groups = ''
